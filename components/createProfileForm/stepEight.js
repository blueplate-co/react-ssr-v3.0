...
export default class ProfileStepEight extends React.Component {
    ...
    saveAndContinue = (e) => {
        ...
        if (validator.trim(this.refs.content.value).length == 0) {
            errorStack.push('Please give us a little bit more about why you start cooking.');
            // have error
        ...
        return (
            <div className="create_profile_step">
                ...
                <div className="container">
                    ...
                    <textarea ref="content" rows="20" cols="50" defaultValue={this.props.fieldValues.reason}></textarea>
                </div>
