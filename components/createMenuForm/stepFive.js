            ...
            <div className="create_profile_step">
                ...
                <div className="container">
                    ...
                    <div style={{ display: 'inline-flex' }}>
                        ...
                        <input ref="hours" className="hours" onChange={this.hourFill} style={{ width: '50%' , marginRight: '3%', textAlign: 'center' }} type="text" placeholder="hours"/>
                        <input ref="mins" className="mins" onChange={this.minFill} style={{ width: '25%', textAlign: 'right' }} type="text" placeholder="mins"/>
                    </div>
                </div>
